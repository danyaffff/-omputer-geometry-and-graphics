...
// ./<название> <имя входного файла (example_input.ppm)> <имя выходного файла (example_output.ppm)> <яркость (0...255)> <Толщина (>0)> <x начала> <y начала> <x конца> <y конца> <значение гаммы (>0)>
...
int main(int argc, char * argv[]) {
    ...
    try {
        ...
        fin >> version >> width >> height >> color;
