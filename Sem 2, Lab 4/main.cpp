...
// ./<название программы> -f <название цветового пространства входного файла (RGB, HSV, etc.)> -i <количество входных файлов (1, 3)> <название входного файла (example_input.ppm)> -t <название цветового пространства выходного файла (RGB, HSV, etc.)> -o <количество выходных файлов (1, 3)> <название входного файла (example_input.ppm)>
